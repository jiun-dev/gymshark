...
$(function() {
    ...
    function setGnb() {
        ...
        $('#gnb > ul > li > a').each(function() {
            if ($(this).parent().find('ul').length > 0) {
                $(this).append('<i class="fas fa-chevron-down mobile"></i>'); //
            }
        });
    ...
    function setImageSlide(selector, status, speed) {
        ...
        $(selector).find('ul.slide li').each(function(i) {
            $(selector).find('ul.indicator').append('<li><a href="#">' + (i + 1) + '甕곤옙 占싼됱뵬占쎈�諭� 癰귣떯由�</a></li>\n');
    ...
    //
    setScrollEffect('#lab ul li');
    setScrollEffect('#lab div.img a');
    ...
    //
    setBoard('#board dl.gymshark-news');
